...
export default function Contact() {
  return (
    <SectionContainer id="contato" name="contato" headerText="Como entrar em contato?" justifyContent="center" alignItems="center useHeaderStyle>
      <Flex as={Grid} container item xs={9} sm={6} pl={4} pr={4}>
